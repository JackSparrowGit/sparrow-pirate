 ...
 *  @generated
 */
package com.corsair.sparrow.pirate.gamma.api;

@SuppressWarnings({"cast", "rawtypes", "serial", "unchecked", "unused"})
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.12.0)", date = "2019-04-17")
public class GammaThriftService {

  public interface Iface {

    public GammaDTO getById(long id) throws org.apache.thrift.TException;

    public java.util.List<GammaDTO> search(GammaQuery query) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void getById(long id, org.apache.thrift.async.AsyncMethodCallback<GammaDTO> resultHandler) throws org.apache.thrift.TException;

    public void search(GammaQuery query, org.apache.thrift.async.AsyncMethodCallback<java.util.List<GammaDTO>> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public GammaDTO recv_getById() throws org.apache.thrift.TException
    {
    ...
    public void send_search(GammaQuery query) throws org.apache.thrift.TException
    {
    ...
    public java.util.List<GammaDTO> recv_search() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getById_call extends org.apache.thrift.async.TAsyncMethodCall<GammaDTO> {
      private long id;
      public getById_call(long id, org.apache.thrift.async.AsyncMethodCallback<GammaDTO> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public GammaDTO getResult() throws org.apache.thrift.TException {
    ...
    public static class search_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<GammaDTO>> {
      private GammaQuery query;
      public search_call(GammaQuery query, org.apache.thrift.async.AsyncMethodCallback<java.util.List<GammaDTO>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.query = query;
      }
      ...
      public java.util.List<GammaDTO> getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new java.lang.IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getById<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getById_args, GammaDTO> {
      public getById() {
        super("getById");
      }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<GammaDTO> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<GammaDTO>() { 
          public void onComplete(GammaDTO o) {
            getById_result result = new getById_result();
            result.success = o;
            try {
      ...
      public void start(I iface, getById_args args, org.apache.thrift.async.AsyncMethodCallback<GammaDTO> resultHandler) throws org.apache.thrift.TException {
        iface.getById(args.id,resultHandler);
      }
    }

    public static class search<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, search_args, java.util.List<GammaDTO>> {
      public search() {
        super("search");
      }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<java.util.List<GammaDTO>> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<java.util.List<GammaDTO>>() { 
          public void onComplete(java.util.List<GammaDTO> o) {
            search_result result = new search_result();
            result.success = o;
            try {
              fcall.sendResponse(fb, result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, search_args args, org.apache.thrift.async.AsyncMethodCallback<java.util.List<GammaDTO>> resultHandler) throws org.apache.thrift.TException {
  ...
  public static class getById_result implements org.apache.thrift.TBase<getById_result, getById_result._Fields>, java.io.Serializable, Cloneable, Comparable<getById_result>   {
    ...
    public @org.apache.thrift.annotation.Nullable GammaDTO success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, GammaDTO.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public getById_result(getById_result other) {
      if (other.isSetSuccess()) {
        this.success = new GammaDTO(other.success);
      }
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public GammaDTO getSuccess() {
      return this.success;
    }

    public getById_result setSuccess(@org.apache.thrift.annotation.Nullable GammaDTO success) {
      this.success = success;
      return this;
    }
  ...
  public static class search_args implements org.apache.thrift.TBase<search_args, search_args._Fields>, java.io.Serializable, Cloneable, Comparable<search_args>   {
    ...
    public @org.apache.thrift.annotation.Nullable GammaQuery query; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.QUERY, new org.apache.thrift.meta_data.FieldMetaData("query", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, GammaQuery.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public search_args(search_args other) {
      if (other.isSetQuery()) {
        this.query = new GammaQuery(other.query);
      }
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public GammaQuery getQuery() {
      return this.query;
    }

    public search_args setQuery(@org.apache.thrift.annotation.Nullable GammaQuery query) {
      this.query = query;
      return this;
    }
  ...
  public static class search_result implements org.apache.thrift.TBase<search_result, search_result._Fields>, java.io.Serializable, Cloneable, Comparable<search_result>   {
    ...
    public @org.apache.thrift.annotation.Nullable java.util.List<GammaDTO> success; // required
    ...
    public search_result(
      java.util.List<GammaDTO> success)
    {
      this();
      this.success = success;
    }
    ...
    public search_result(search_result other) {
      if (other.isSetSuccess()) {
        java.util.List<GammaDTO> __this__success = new java.util.ArrayList<GammaDTO>(other.success.size());
        for (GammaDTO other_element : other.success) {
          __this__success.add(new GammaDTO(other_element));
        }
    ...
    @org.apache.thrift.annotation.Nullable
    public java.util.Iterator<GammaDTO> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(GammaDTO elem) {
      if (this.success == null) {
        this.success = new java.util.ArrayList<GammaDTO>();
      }
      this.success.add(elem);
    }

    @org.apache.thrift.annotation.Nullable
    public java.util.List<GammaDTO> getSuccess() {
      return this.success;
    }

    public search_result setSuccess(@org.apache.thrift.annotation.Nullable java.util.List<GammaDTO> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((java.util.List<GammaDTO>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<GammaDTO>(_list0.size);
                  @org.apache.thrift.annotation.Nullable GammaDTO _elem1;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, search_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (GammaDTO _iter3 : struct.success)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (GammaDTO _iter4 : struct.success)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<GammaDTO>(_list5.size);
            @org.apache.thrift.annotation.Nullable GammaDTO _elem6;
